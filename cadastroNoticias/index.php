    ...
    <body>
        ...
        <div id="menu">
            <ul>
                ...
                <li id="button2"><a href="visao/guicadastronoticia.php" title="">Cadastro de Noticia</a></li>
                <li id="button3"><a href="controle/noticiacontrole.php?op=listar" title="">Busca de Noticias</a></li>
